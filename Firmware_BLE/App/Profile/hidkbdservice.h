...
#define HID_RPT_ID_KEY_IN      1      // 键盘输入报告 ID = 1
#define HID_RPT_ID_MEDIA_IN    2      // 多媒体控制输入报告 ID = 2
#define HID_RPT_ID_LED_OUT     3      // LED 输出报告 ID = 3
//#define HID_RPT_ID_FEATURE     0      // 特性报告 ID = 0（暂时不用）
